...
// Si tu as déjà ces paliers dans data/badges, tu peux importer à la place.
// Ici on met la source de vérité locale pour être plug&play.
const TIERS = [
...
export default function TiersShowcase() {
  const spend = mockUser.totalSpend
        ...
        {TIERS.map((t, i) => {
          ...
          return (
            ...
            >
              ...
              {/* Petit indicateur linéaire sur la carte */}
